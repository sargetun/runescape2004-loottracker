...
from screens.kill_entry import KillEntryScreen
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.screen_kills = KillEntryScreen(self.monsters, self.storage)
        self.screen_stats = BaseScreen()   # StatsScreen to be implemented
